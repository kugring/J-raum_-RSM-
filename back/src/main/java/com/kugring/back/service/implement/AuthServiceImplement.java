...
public class AuthServiceImplement implements AuthService {
    ...
    private PasswordEncoder passwordEncoder = new BCryptPasswordEncoder(); // 스프링 시큐리티 cryto에서 제공하는 passwordEncoder이다!
    ...
    public ResponseEntity<? super IdCheckResponseDto> idCheck(IdCheckRequestDto dto) {
        ...
        try {
            ...
            if(isExisted) return IdCheckResponseDto.duplicateId();
    ...
    public ResponseEntity<? super SignInResponseDto> signIn(SignInRequestDto dto) {
        ...
        try {
            ...
            String password = dto.getPassword();
            String encodedPssword = userEntity.getPassword();
            boolean isMatched = passwordEncoder.matches(password, encodedPssword);
