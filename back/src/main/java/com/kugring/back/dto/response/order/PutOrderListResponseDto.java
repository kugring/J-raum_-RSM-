...
@Getter
public class PutOrderListResponseDto extends ResponseDto {

  private PutOrderListResponseDto() {
    super();
  }

  // 성공 응답
  public static ResponseEntity<PutOrderListResponseDto> success() {
    PutOrderListResponseDto result = new PutOrderListResponseDto();
