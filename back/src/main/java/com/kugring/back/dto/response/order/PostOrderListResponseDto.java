...
@Getter
public class PostOrderListResponseDto extends ResponseDto {

  private PostOrderListResponseDto() {
    super();
  }

  // 성공 응답
  public static ResponseEntity<PostOrderListResponseDto> success() {
    PostOrderListResponseDto result = new PostOrderListResponseDto();
